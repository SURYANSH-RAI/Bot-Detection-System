...
import { Upload, AlertTriangle, FileText, Link2, User, Cpu } from 'lucide-react';
import Papa from 'papaparse';
import { Alert, AlertDescription, AlertTitle } from '@/components/ui/alert';

// API endpoints for backend
const API_ENDPOINTS = {
  ML_ANALYSIS: 'http://your-backend-url/api/ml-analysis',
  RULE_BASED_ANALYSIS: 'http://your-backend-url/api/rule-based-analysis'
};
...
const BotDetectionSystem = () => {
  ...
  const processData = async () => {
    ...
    try {
      ...
      const endpoint = analysisMethod === 'ml' 
        ? API_ENDPOINTS.ML_ANALYSIS 
        : API_ENDPOINTS.RULE_BASED_ANALYSIS;
  ...
  return (
    <div className="min-h-screen bg-gray-900 text-gray-100 relative overflow-hidden">
      ...
      <div className="max-w-4xl mx-auto p-6 space-y-6 relative">
        ...
        {error && (
          <Alert variant="destructive" className="bg-red-900/50 border-red-800 text-red-200 backdrop-blur-sm">
